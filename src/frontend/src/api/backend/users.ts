...
export class UserBackend {
    ...
    constructor(accountServiceUrl: string, loginServiceUrl: string, brokerServiceUrl: string) {
    ...
    async loginXml(xmlBuilder: XMLBuilder, xmlParser: XMLParser, 
    ...
    async logoutXml(xmlBuilder: XMLBuilder, xmlParser: XMLParser, 
                    accountId: number) {
    ...
    async signupXml(xmlBuilder: XMLBuilder, xmlParser: XMLParser, 
