...
import { ServiceVersion, ServiceVersionSuccess, ServiceVersionUrl } from "./types"
import {
...
const services: ServiceVersionUrl[] = [
    { serviceName: 'Account Service',           versionUrl: '/accountservice/api/version' },
    { serviceName: 'Broker Service',            versionUrl: '/broker-service/version' },
    { serviceName: 'Credit Card Order Service', versionUrl: '/credit-card-order-service/version' },
    { serviceName: 'Engine',                    versionUrl: '/engine/api/version' },
    { serviceName: 'Feature Flag Service',      versionUrl: '/feature-flag-service/version' },
    ...
    { serviceName: 'Third Party Service',       versionUrl: '/third-party-service/version' }
]
