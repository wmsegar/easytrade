...
public class FakeInstrumentRepository : FakeTransactionalRepository, IInstrumentRepository
{
    ...
    public FakeInstrumentRepository(List<Instrument> instruments, List<OwnedInstrument> ownedInstruments)
    ...
    {
        var ownedInstrument = _ownedInstruments.Find(x => x.AccountId == accountId && x.InstrumentId == instrumentId);
