...
public class InstrumentTests
{
    ...
    public async Task GetInstruments_WithValidInput_ShouldReturnInstruments()
    {
        ...
        var instrumentService = BuildFakeInstrumentService(_instruments, ownedInstruments, _products, _prices);
    ...
    {
        // Arrange
        var instrumentService = BuildFakeInstrumentService(_instruments, Array.Empty<OwnedInstrument>(), _products, _prices);
    ...
    private InstrumentService BuildFakeInstrumentService(Instrument[] instruments, OwnedInstrument[] ownedInstruments, Product[] products, Price[] prices)
    {
        ...
        return new InstrumentService(_instrumentRepository, _priceServiceConnector, _productRepository, logger);
    }
}