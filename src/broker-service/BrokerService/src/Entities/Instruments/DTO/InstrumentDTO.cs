...
public class InstrumentDTO
{
    ...
    public InstrumentDTO(Instrument instrument, OwnedInstrument? ownedInstrument, Product product, Price price)
    {
        Id = instrument.Id;
    ...
    public InstrumentDTO(int id, string code, string name, string description, int productId, string productName, PriceDTO price, decimal amount)
    {
        Id = id;
        Code = code;
        Name = name;
